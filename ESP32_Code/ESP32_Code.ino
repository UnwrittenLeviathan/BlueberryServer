...
void sendStatusUpdate() {
    ...
    statusReport += "\"minFrameTime\":" + String(minCaptureTime) + ",";
    statusReport += "\"maxFrameTime\":" + String(maxCaptureTime) + ",";
    ...
    minCaptureTime = ULONG_MAX;
    maxCaptureTime = 0;
    
    String wrappedStatus = "JSN:" + statusReport;
    webSocket.sendTXT(wrappedStatus);
    Serial.println(wrappedStatus);
}