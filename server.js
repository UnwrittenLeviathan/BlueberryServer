...
Also add buffer array object to append jpeg data to while buffer is not writable, then write buffer and flush it after it is started again.
Make temperature notifications silent unless significant.
